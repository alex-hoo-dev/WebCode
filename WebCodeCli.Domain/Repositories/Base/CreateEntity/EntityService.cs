...
namespace WebCodeCli.Domain.Repositories
{
    ...
    public class EntityService : IEntityService
    {
        ...
        {
            ConnectionString = DBConnectionOption.Instance.ConnectionStrings,
            DbType = (SqlSugar.DbType)Enum.Parse(typeof(SqlSugar.DbType), DBConnectionOption.Instance.DbType),
